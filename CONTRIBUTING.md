# Contributing to 5e Initiative Tracker

First off, thank you for considering contributing to `5e-initiative-tracker`! It's people like you that make open source so great.

## Where do I go from here?

If you've noticed a bug or have a feature request, [make one](https://github.com/dyka3773/5e-initiative-tracker/issues/new)! It's generally best if you get confirmation of your bug or approval for your feature request this way before starting to code.

### Fork & create a branch

If this is something you think you can fix, then [fork `5e-initiative-tracker`](https://github.com/dyka3773/5e-initiative-tracker/fork) and create a branch with a descriptive name.
...
```bash
git clone https://github.com/dyka3773/5e-initiative-tracker.git
cd 5e-initiative-tracker
```
